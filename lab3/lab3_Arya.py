...
print("-------example1: strings------")
name = "Michael Jackson"
print(name[::2])
print(name[3:10:2])


print("-------example2: strings methods------")
name1 = name.upper()
name2 = name.lower()
...
if match:
    print(f"Zipcode found = {match.group()}")
else:
...
#nested tuple
nestedtuple = (1,2, ("pop","rock"), (3,4),("dicso",(8,9)))
...
#create set
set1 = {"pop", "rock", "soul", "hard rock", "rock", "r&b","dicso","rock"}
print(set1)
...
print(album1 | album2)
#difference, ^ , returns the elements that are in one set but not in both the other set
print(album1 ^ album2)
